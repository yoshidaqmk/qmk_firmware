...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   */
    [_QWERTY] = LAYOUT3(
      KC_ESC,        KC_Q,    KC_W,    KC_E,    KC_R,  KC_T,      KC_Y,   KC_U,  KC_I,    KC_O,    KC_P,    KC_BSPC,    KC_1,    KC_2,    KC_3,      KC_4,    KC_5,    KC_GRV,
      GUI_T(KC_TAB), KC_A,    KC_S,    KC_D,    KC_F,  KC_G,      KC_H,   KC_J,  KC_K,    KC_L,    KC_SCLN, KC_QUOT,    KC_6,    KC_7,    KC_8,      KC_9,    KC_0,    KC_BSLS,
      KC_LSFT,       KC_Z,    KC_X,    KC_C,    KC_V,  KC_B,      KC_N,   KC_M,  KC_COMM, KC_DOT,  KC_UP,   KC_SLSH,    KC_PGUP, KC_UP,   KC_PGDOWN, KC_HOME, KC_MINS, KC_EQL,
      KC_LCTL,       ADJUST,  KC_LALT, KC_LCTL, LOWER, KC_SPC,    KC_ENT, RAISE, KC_MINS, KC_LEFT, KC_DOWN, KC_RGHT,    KC_LEFT, KC_DOWN, KC_RIGHT,  KC_END,  KC_LBRC, KC_RBRC
    ),
  /* Colemak
   * ,-----------------------------------------.             ,-----------------------------------------.             ,-----------------------------------------.
